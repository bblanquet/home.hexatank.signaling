...
import { ExitObs } from './Observers/ExitObs';
import { NetworkMessage } from './Message/NetworkMessage';
import * as socketio from 'socket.io';
import * as http from 'http';
import { RoomManager } from './Structure/RoomManager';
import { RoomnameObs } from './Observers/RoomnameObs';
...
export class IoContext {
	...
	constructor(httpServer: http.Server) {
		...
		this._ioServer.on(PacketKind[PacketKind.connection], (socket: socketio.Socket) => {
			...
			[
				new ExitObs(PacketKind.Leave, this._roomManager, this._ioServer, socket),
				...
				new RoomnameObs(PacketKind.Available, this._roomManager, this._ioServer, socket),
